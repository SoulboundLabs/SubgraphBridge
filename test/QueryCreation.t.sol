...
contract QueryCreation is Test {
    ...
    bytes public onlineBlockHash1 =
        hex"307865656535313762633863326364616637623161313232313631323233666439643239643235663932353062303731633936346435303863356139636230656533";
    bytes32 public requestCID1 =
        0x200d785a4e650a6d55daec459392da7c1e22a3304710221a0b807e2260626aca;

    // for second query test
    bytes32 public blockHash2 =
        0x5b1dc013f92873fe9017f28612ef67a5b141e83f75f036d9cb7c8e1b8ef805be;
    bytes public onlineBlockHash2 =
        hex"307835623164633031336639323837336665393031376632383631326566363761356231343165383366373566303336643963623763386531623865663830356265";
    bytes32 public requestCID2 =
    ...
    bytes public totalQueryHex1 =
        hex"";

    bytes public totalQueryHex2 =
        hex"";
    ...
    function testKeccakStrings() public {
        ...
        assertEq(
            wordHash,
            0x34bba2d182f6f70dcdc5d2962126622c60729eea6534226f87b35dd2bd3045d4
        );
    }

    function testActualSubgraphQueries() public {
        bytes memory bytesBlockHash1 = toHexBytes(blockHash1);
        bytes memory generatedQuery1 = bytes.concat(
            firstChunk,
            bytesBlockHash1,
            lastChunk
        );
        ...
        bytes memory generatedQuery2 = bytes.concat(
            firstChunk,
            bytesBlockHash2,
            lastChunk
        );
    ...
    function testAddressFromString() public {
        address addr = address(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
        bytes memory str = abi.encode(addr);
        address parsed = abi.decode(str, (address));
        assertEq(addr, parsed);
    }
