...
interface ISubgraphBridge {
  ...
  function createSubgraphBridge(SubgraphBridge memory subgraphBridge) external;
  ...
  function subgraphBridgeData(bytes32 bridgeID, bytes32 requestCID) external view returns(BridgeDataType);
}
